...
### Removed because it is 0 after the euro introduction i.e. variance is 0
...
### INT: Interest
  ...
  ## "DT.ODA.ALLD.KD",            # Net official development assistance and official aid received (constant 2013 US$)
  ...
  ## "DT.ODA.ODAT.KD",            # Net official development assistance received (constant 2014 US$)
...
### I am sure that there is an area/# of threatened species relationship, but i will still leave it in
...
### not sure about this one
  ...
  ## "IE.PPN.TELE.CD",            # Public private partnerships investment in telecom (current US$)
...
### LCU: Constant local currency
  ...
  ## "NE.CON.PETC.KD",            # Household final consumption expenditure, etc. (constant 2010 US$)
  ...
  ## "NE.CON.PRVT.KD",            # Household final consumption expenditure (constant 2010 US$)
  ...
  ## "NY.ADJ.NNTY.PC.KD",         # Adjusted net national income per capita (constant 2010 US$)
  ...
  "SH.UHC.NOP2.CG",            # Increase in poverty gap at $3.10 ($ 2011 PPP) poverty line due to out-of-pocket health care expenditure (USD)
  ## "SH.UHC.NOP2.TO",            # Number of people pushed below the $3.10 ($ 2011 PPP) poverty line by out-of-pocket health care expenditure
  "SH.UHC.NOP2.ZG",            # Increase in poverty gap at $3.10 ($ 2011 PPP) poverty line due to out-of-pocket health care expenditure (% of poverty line)
  "SH.UHC.NOP2.ZS",            # Proportion of population pushed below the $3.10 ($ 2011 PPP) poverty line by out-of-pocket health care expenditure (%)
...
### Large countries large wars? => I think it is ok to leave them in
