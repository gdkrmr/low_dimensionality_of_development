...
## Bootstrap the data
get_data_file <- function(name) paste0(DATA_DIR, "/", name)
...
get_number_of_variables <- function(start_year, end_year,
  ...
  wdi_data_4 <- wdi_data_3[, c(1:2, which(col_idx) + 2)]
...
# nolint start
  ...
  hdi_data$`Country Code`[hdi_data$`Country` == "C\U3e34663cte d'Ivoire"]                    <- "CIV"
